...
TEST(ZconvContribOpTest, two_by_two_float) {
  OpTester test("Zconv", 1, kMSDomain);
  test.AddInput<float>("X", {2, 2}, {4, 7, 2, 6});
  test.AddOutput<float>("Y", {2, 2}, {0.6f, -0.7f, -0.2f, 0.4f});
  test.Run();
}

TEST(ZconvContribOpTest, two_by_two_double) {
  OpTester test("Zconv", 1, kMSDomain);
...
TEST(ZconvContribOpTest, two_by_two_float16) {
  OpTester test("Zconv", 1, kMSDomain);
...
TEST(ZconvContribOpTest, four_by_four_float) {
  OpTester test("Zconv", 1, kMSDomain);
...
TEST(ZconvContribOpTest, four_by_four_batches_float) {
  OpTester test("Zconv", 1, kMSDomain);
